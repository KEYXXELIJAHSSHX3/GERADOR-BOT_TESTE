...
wget https://github.com/KEYXXELIJAHSSHX3/GERADOR-BOT_TESTE/raw/main/Install/GERADOR-BOT_TESTE.zip
unzip GERADOR-BOT_TESTE.zip
rm -rf GERADOR-BOT_TESTE.zip
cd
}
...
fun_montaip () {
fun_ip
sed -i "s;15.228.127.48;$IP;g" /var/www/html/scripts/Plus
fun_ip
sed -i "s;15.228.127.48;$IP;g" /home/list
fun_ip
sed -i "s;15.228.127.48;$IP;g" /home/index.html
sleep 3s
}
